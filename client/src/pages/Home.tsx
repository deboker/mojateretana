      ...
      <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-border z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <a href="#prednosti" className="text-sm hover:text-primary transition-colors">Prednosti</a>
            ...
            <Card className="border-2 border-primary hover:shadow-2xl transition-all relative">
              ...
              <CardContent>
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    <span><strong className="text-primary">Ušteda 1000 RSD</strong> u odnosu na jednokratne ulaze</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
